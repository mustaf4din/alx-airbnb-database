...
-- =====================================================
-- SUMMARY OF 3NF CHANGES
-- =====================================================
-- 
-- ONLY ONE CHANGE MADE:
-- - Removed 'total_price' column from Booking table
-- - Added 'BookingWithPrice' view to calculate total_price
-- 
-- WHY: total_price was a derived attribute that violated 3NF
--      (it could be calculated from price_per_night × nights)
-- 
