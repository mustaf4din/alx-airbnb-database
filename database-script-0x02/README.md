...
### Users (12 total)
    ...
    5 Hosts - From different countries (US, UK, Spain)
    6 Guests - Various locations and backgrounds
    1 Admin - System administrator

### Properties (10 total)

    Diverse Locations: NYC, LA, London, Barcelona, Denver, etc.
    Various Types: Apartments, villas, cabins, lofts, cottages
    Realistic Prices: $120-$500 per night based on location/type
    Detailed Descriptions with amenities and selling points

### Bookings (12 total)

    6 Confirmed - With corresponding payments
    2 Pending - Awaiting host confirmation
    1 Canceled - Shows booking lifecycle
    3 Past Bookings - For review/rating data

### Payments (9 total)

    Multiple Payment Methods: Credit card, PayPal, Stripe
    Calculated Amounts: Based on nights × price_per_night
    Realistic Timing: Payments made shortly after booking

### Reviews (7 total)

    Ratings 4-5 stars - Realistic positive feedback
    Detailed Comments - Authentic guest experiences
    Variety of Perspectives - Different aspects highlighted

### Messages (10 total)

    Pre-booking Inquiries - Property availability questions
    Booking Coordination - Check-in instructions, logistics
    Support Requests - Help with access, amenities
    Post-stay Follow-up - Review requests, thank you notes
